<!-- Agent: 视觉 Brief 完整规则 — 封面停滑五铁律、概念检查、配色第一性原则、风格锚点库、MJ Prompt架构规范。STEP 8 加载。-->

# 视觉 Brief 完整规则（STEP 8 参考文档）

> **目录：** 停滑五铁律 · Disturbing检查 · 速查卡 · 8.0 最高法则 · 8.1 策略矩阵 · 8.2 情绪本体优先 · 8.3 凝固不可能 · 8.4 风格调色板 · 8.0.5 MJ架构 · 8.5 3秒+美感 · 8.7 可执行性 · 8.8 输出规范 · 8.9 风格锚点 · 8.10 审美自检
...
> 执行顺序：封面停滑五铁律 → Disturbing检查 → 8.0 最高法则 → 8.1 视觉策略 → 8.2 情绪本体检验 → 8.3 凝固不可能状态 → 8.4 风格选择 → 8.0.5 Prompt架构 → 写 Prompt → 8.5 3秒+美感 → 8.7 可执行性 → 8.8 输出规范 → 8.9 风格锚点 → 8.10 审美自检
...
## 8.0.5 MJ v8.1 Prompt 架构规范（写第一个Prompt前必读）
